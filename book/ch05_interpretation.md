...
__Նախապայմանով կրկնություն։__ `WHILE` հրամանի ինտերպրետացիան է՛լ ավելի ապրզ է. այստեղ `for` ցիկլի մեջ հաշվարկվում է պայմանը, ստուգվում է, որ այն ունենա տրամաբանական արժեք, ու, քանի դեռ ճշմարիտ է, կատարվում է մարմինը։
...
__Պարամետրով կրկնություն։__ `FOR` կառուցվածքի ինտերպրետացիան բարդ է թվում դրա քերականության պատճառով, բայց այստեղ էլ, ուշադիր կարդալով, տեսնում ենք, որ ամեն ինչ շատ հասարակ է։ |

Քանի որ սա պարամետրով ցիկլ է, ուրեմն ամենասկզբում ստուգում ենք, որ այդ պարամետրը փոփոխական լինի։ Եթև քերականությունն այլ բան թույլ չի տալիս, այնուամենայնիվ՝ ստուգենք։
...
Հետո հաշվում ենք պարամետրի սկզբնական արժրքը, ստուգում ենք դրա տիպը ու միջավայրում ստեղծում ենք նոր փոփոխական՝ պարամետրի անունով ու այս հաշվարկված արժեքով։
...
Նույն կերպ հաշվարկում ենք ցիկլի պարամետրի վերջնական արժեքը ու անպայման ստուգում ենք տիպը։ 
...
Պարամետրի արժեքի փոփոխման քայլն էլ ենք հաշվում մինչև կրկնություն կազմակերպելը ու նորից համոզվում ենք, որ այն թիվ է։
...
Մարմին կատարումը մի քիչ տարբերվում է `WHILE` հրամանի մարմնի կատարումից։ Այստեղ կրկնությունը պետք է շարունակվի այնքան ժամանակ, քանի պարամետրի արժեքը չի անցել վերջնական արժեքը՝ կախված քայլի նշանից։ Ուրեմն, ցիկլի մեջ, առաջին քայլով, վերցնում ենք պարամետրի արժեքն ու ստուգում ենք, որ այն դեռ հասած չլինի վերջնական արժեքին։ Երբ փոփոխման քայլը՝ `step`-ը դրական է, ապա պարամետրը պետք է փոքր կամ հավասար լինի վերջնական արժեքին։ Երբ `step`-ը բացասական է, ապա պարամետրը պետք է մեծ կամ հավասար լինի վերջնական արժեքին։ Այս պայմանի խախտումն ավարտում է ցիկլը։ Հաջորդ քայլով ինտերպրետացնում ենք մարմնի հրամաններ։ Ու վերջում պարամետրի ընթացիկ արժեքին գումարում ենք փոփոխման քայլի արժեքը։ Պարզ է, որ `step`-ի դրական լինելու դեպքում պարամետրի արժեքը մեծանալու է, իսկ բացասական լինելու դեպքում՝ փոքրանալու։
...
__Ենթածրագրի կանչ։__ Այն ինչ պիտի ասվի ենթապրագրի կանչի `CALL` հրամանի ինտերպրետացիայի մասին, արդեն ասվել է արտահայտությունների հաշվարկման բաժնում՝ `evaluateApply()` մեթոդի քննարկման ժամանակ։ Այստեղ կիրականացնենք `executeCall()` մեթոդը, որը կանչում է `ecaluateApply()` մեթոդը ու անտեսում է դրա վերադարձրած արժեքը։
