...
_Բալը_ ուսումնական նախագիծ է։ Շարահյուսության տեսակետից, հիմնականում ընդօրինակված լինելով Բեյսիկ լեզվից, այն չի պարունակում բարդ լեզվական կառուցվածքներ։ Այս պարզությունը մեզ թույլ է տալիս կենտրոնանալ շարահյուսական վերլուծիչի ու ինտերպրետատորի իրականացման մեթոդների ու հնարքների վրա՝ միաժամանակ խուսափելով լեզվի բարդ կառուցվածքներ մոդելավորելու անհրաժեշտությունից։ Բայց, թերևս ավելի կարևորը, այս նախագիծը ընդլայնման ու կատարելագործման լայն հնարավորություններ է թողնում։

Այս գլխում ծանոթանում ենք Բալ լեզվի շարահյուսությանը և հիմնական կառուցվածքներին։ Բեկուսի–Նաուրի ընդլայնված գրառումն (EBNF, Extended Backus–Naur Form) օգտագործելով՝ լեզուն սահմանում ենք ֆորմալ եղանակով։ Յուրաքանչյուր լեզվական կառուցվածքի համար բերված են նաև գործնական օրինակներ։

Սկսենք լեզվի տիպավորման մոդելից։ Բալը դինամիկ տիպիզացվող լեզու է․ այսինքն՝ փոփոխականի տիպը որոշվում է նրան վերագրված արժեքի տիպով։ Հետևյալ օրինակում `a` փոփոխականին նախ վերագրվում է `3.14159` իրական թիվը, ապա՝ `A line of text.` տեքստը․
...
Միևնույն ժամանակ, լեզվում բոլոր գործողություններում խստորեն ստուգվում են արժեքների տիպերը։ Օրինակ, չի թույլատրվում տեքստը բազմապատկել թվով կամ զանգվածը բաժանել տեքստի, ինչը օգնում է ժամանակին հայտնաբերել ծրագրավորման սխալները։
...
Այստեղ `[` և `]` փակագծերով որոշվում է «պարփակված արտահայտության առկայություն կամ բացակայություն»։ `{` և `}` փակագծերը նշանակում են «պարփակված արտահայտության զրո կամ ավելի կրկնություններ»։ Տվյալ դեպքում՝ գրված է, որ ծրագիրը կարող է սկսվել ոչ պարտադիր նոր տողի նիշերով․ `[NewLines]` ու շարունակվել որպես `Subroutine` տարրի զրո և ավելի անգամ կրկնություններ՝ ավարտված նոր տողի նիշերով։ 

`NewLines`-ը մեկ կամ ավելի նոր տողին անցման նիշերի հաջորդականություն է։ Սահմանված ասյպիսի կանոնով․
...
`[...]` կառուցվածքով նշված է, որ իդենտիֆիկատորների ցուցակը կարող է նաև բացակայել։ `Subroutine`֊ի քերականական կանոնից երևում է, որ երբ պարամետրերի ցուցակը դատարկ է, ապա կարելի է բաց թողնել նաև կլոր փակագծերը։ Օրինակ, ենթածրագրերի `SUB Ok()` և `SUB Ok` վերնագրերը համարժեք են։

Պետք է նշել, որ Բալը ենթածրագրից արժեք վերադարձնող հատուկ հրաման չունի (ինչպիսին է, օրինակ Գո լեզվի `return`-ը): Վերադարձվող արժեքը վերագրվում է ենթածրագրի անունին (ինչպես, օրինակ, Պասկալ կամ Բեյսիկ լեզուներոմ)։ Օրինակ, հետևյալ ենթածրագիրը, հաշվում ու վերադարձնում է երկու արժեքներից մեծը.
...
Լեզվի նախատեվում են ութ հրաման կամ ղեկավարող կառուցվածք՝ նախատեսված միաչափ զանգվածների սահմանման, վերագրման, ներմուծման ու արտածման, ճյուղավորման, կրկնությունների և ենթածրագրի կանչի համար։ 
